...
i18n.prototype = {
    ...
    readFile: function (locale) {
        ...
        // Argi Karunia
        var file = this.locateFile('global');
        ...
        try {
            ...
            try {
                ...
                // Argi Karunia
                this.initLocale(locale, this.parseLocale(locale, localeFile));
    ...
    parseLocale: function (locale, filepath) {
        var buffer = JSON.parse(filepath);
        var data = {};

        for (var key in buffer) {
            data[key] = buffer[key][locale];
        }
    ...
    locateFile: function (locale) {
        return path.safe(this.directory + '/' + locale + this.extension);
    },
