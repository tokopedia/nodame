...
var Package         = require('file').readJSON(sprintf('%s/package.json', nodame.sysPath()));
nodame.set('app', {
    name        : Package.name,
...
if (argv.config !== undefined) {
    ...
    var configDir = IS_DEV ? 'config-devel' : 'configs';
