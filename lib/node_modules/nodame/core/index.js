...
module.exports = (function () {
    ...
    var __require = function (name) {
        ...
        if (vars[0] === 'my_modules') {
            return require(__getFilePath('modules', vars[1]));
        } else {
            return require(name);
        }
    };
    ...
    var enforceMobile = function () {
        var self = this;
        var viewCfg = settings.config.view;

        return function (req, res, next) {
            if (viewCfg.mobile && viewCfg.enforce_mobile) {
                switch (viewCfg.enforce_mobile_type) {
                    case 'soft':
                ...
                if (next && viewCfg.enforce_mobile_type !== 'hard') return next();
            } else {
                return next();
            }
        };
