...
if (nodame.config('view.device_capture') && nodame.config('view.enforceMobile')) {
...
if (nodame.config('server.bootwares').length > 0) {
    for (var bootware in nodame.config('server.bootwares')) {
        nodame.require(sprintf('my_modules/%s', bootware)).boot();
    }
}
