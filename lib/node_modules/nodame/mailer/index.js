...
var mailer = (function () {
    ...
    var alert = function (subject, err) {
        var message = {
            'html'      : err,
            'subject'   : subject,
            'from_email': nodame.config.logger.email_from_addr,
            'from_name' : nodame.config.logger.email_from_name,
            'to': [
                {
                    'email' : nodame.config.logger.email_to_addr,
                    'name'  : nodame.config.logger.email_to_name,
                    'type'  : 'to'
                }
            ],
            'headers': {
                'Reply-To': nodame.config.logger.email_from_addr
            },
            'important': false,
            'track_opens': true,
            'track_clicks': true,
