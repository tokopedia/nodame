var logger = (function () {
    ...
    if (nodame.config('logger.enable')) {
        var client              = nodame.config('logger.client') || 'syslog';
        ...
        switch (client) {
            ...
            default:
                ...
                var accessFile   = path.normalize(nodame.config('logger.syslog.access_stream'));
                var accessStream = fs.createWriteStream(accessFile, {flags: 'a'});
                var mailer       = require('nodame/mailer');
                var logFile      = path.normalize(nodame.config('logger.syslog.error_stream'));
