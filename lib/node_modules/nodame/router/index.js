...
function router (app) {
    var appName       = nodame.settings.config.app.appname;
    var defaultModule = nodame.settings.config.app.default_module;
    var modules       = nodame.settings.config.modules;
    ...
    // Redirect '/' to 'home'
    if (nodame.settings.config.app.root_redirect) {
